...
const LinkItems = [
  { name: "Productos", icon: FiBox, path: "/" },
  { name: "Acerca de Nosotros", icon: FiCompass, path: "/about" },
  { name: "Contactanos", icon: FiMail, path: "/contact" },
];

const AdminLinkItems = [
  { name: "Productos", icon: FiBox, path: "/backoffice/products" },
  { name: "Usuarios", icon: FiUser, path: "/backoffice/users" },
];
            ...
            <Menu>
              ...
              >
                <HStack>
                  ...
                  >
                    <Text fontSize="sm">
                      {user.name || capitalize(user.email.split("@")[0])}
                    </Text>
